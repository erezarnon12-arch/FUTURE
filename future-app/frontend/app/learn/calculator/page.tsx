...
const COMPANIES: Company[] = [
  {
    ...
    name: "אלטשולר שחם",
    tracks: [
      { id: "default", name: "מסלול נבחר (ברירת מחדל)", feeDeposit: 1.00, feeBalance: 0.22, directExpenses: 0, defaultReturn: 7.0, description: "מסלול ברירת מחדל, חשיפה מאוזנת" },
      { id: "active_stocks", name: "מסלול מניות אקטיבי", feeDeposit: 1.00, feeBalance: 0.25, directExpenses: 0.22, defaultReturn: 8.0, description: "חשיפה גבוהה למניות, ניהול אקטיבי" },
      { id: "sp500", name: "מסלול עוקב S&P 500", feeDeposit: 1.00, feeBalance: 0.08, directExpenses: 0.03, defaultReturn: 9.0, description: "עוקב אחרי מדד S&P 500 האמריקאי" },
      { id: "index_flexible", name: "מסלול עוקב מדדים גמיש", feeDeposit: 1.00, feeBalance: 0.22, directExpenses: 0.07, defaultReturn: 7.5, description: "עוקב מדדים עם גמישות בחשיפה" },
      { id: "halacha", name: "מסלול הלכה", feeDeposit: 1.00, feeBalance: 0.22, directExpenses: 0.05, defaultReturn: 6.5, description: "השקעות בהתאם להלכה יהודית" },
    ],
  },
  {
    id: "meitav",
    name: "מיטב",
    tracks: [
      { id: "default", name: "קרן נבחרת (ברירת מחדל)", feeDeposit: 1.00, feeBalance: 0.22, directExpenses: 0, defaultReturn: 7.0, description: "מסלול ברירת מחדל של מיטב" },
      { id: "conversion_high", name: "מסלול המרה (צבירות גבוהות)", feeDeposit: 2.00, feeBalance: 0.12, directExpenses: 0, defaultReturn: 7.5, description: "לצבירות גבוהות — דמי ניהול נמוכים מהצבירה" },
      { id: "passive_mixed", name: "מסלול פאסיבי משולב", feeDeposit: 1.00, feeBalance: 0.20, directExpenses: 0.05, defaultReturn: 7.5, description: "השקעה פאסיבית בשילוב מדדים" },
      { id: "money_market", name: "מסלול כספי", feeDeposit: 0.50, feeBalance: 0.05, directExpenses: 0.01, defaultReturn: 3.5, description: "מסלול שמרני, דמי ניהול נמוכים מאוד" },
    ],
  },
  {
    id: "menora",
    name: "מנורה מבטחים",
    tracks: [
      { id: "target_under50", name: "מסלול יעד לפרישה (עד 50)", feeDeposit: 1.85, feeBalance: 0.24, directExpenses: 0.23, defaultReturn: 7.0, description: "מסלול ייעודי לצעירים עד גיל 50" },
      { id: "stocks", name: "מסלול מניות", feeDeposit: 1.60, feeBalance: 0.16, directExpenses: 0.21, defaultReturn: 8.5, description: "חשיפה גבוהה למניות" },
      { id: "sp500", name: "מסלול עוקב S&P 500", feeDeposit: 1.15, feeBalance: 0.19, directExpenses: 0.04, defaultReturn: 9.0, description: "עוקב מדד S&P 500" },
      { id: "tradable_mixed", name: "מסלול משולב סחיר", feeDeposit: 1.10, feeBalance: 0.18, directExpenses: 0.04, defaultReturn: 7.5, description: "מסלול מאוזן עם נכסים סחירים" },
      { id: "halacha", name: "מסלול הלכה", feeDeposit: 1.70, feeBalance: 0.25, directExpenses: 0.10, defaultReturn: 6.5, description: "השקעות בהתאם להלכה יהודית" },
    ],
  },
  {
    id: "harel",
    name: "הראל",
    tracks: [
      { id: "under50", name: "מסלול גילאי 50 ומטה", feeDeposit: 1.50, feeBalance: 0.21, directExpenses: 0.22, defaultReturn: 7.0, description: "ברירת מחדל לצעירים עד גיל 50" },
      { id: "stocks", name: "מסלול מניות", feeDeposit: 1.45, feeBalance: 0.19, directExpenses: 0.19, defaultReturn: 8.5, description: "חשיפה גבוהה למניות" },
      { id: "sp500", name: "מסלול עוקב S&P 500", feeDeposit: 1.10, feeBalance: 0.15, directExpenses: 0.04, defaultReturn: 9.0, description: "עוקב מדד S&P 500 האמריקאי" },
      { id: "index_mixed", name: "מסלול מחקה מדדים משולב", feeDeposit: 1.15, feeBalance: 0.16, directExpenses: 0.06, defaultReturn: 7.5, description: "מחקה מדדים משולב" },
      { id: "esg", name: "מסלול קיימות (ESG)", feeDeposit: 1.60, feeBalance: 0.25, directExpenses: 0.15, defaultReturn: 7.0, description: "השקעות אחראיות ומקיימות" },
    ],
  },
  {
    id: "phoenix",
    name: "הפניקס",
    tracks: [
      { id: "under50", name: "מסלול גילאי 50 ומטה", feeDeposit: 1.62, feeBalance: 0.21, directExpenses: 0.24, defaultReturn: 7.0, description: "ברירת מחדל לצעירים עד גיל 50" },
      { id: "foreign_stocks", name: "מסלול מניות חו\"ל", feeDeposit: 1.50, feeBalance: 0.22, directExpenses: 0.20, defaultReturn: 8.5, description: "חשיפה למניות בינלאומיות" },
      { id: "sp500", name: "מסלול עוקב S&P 500", feeDeposit: 1.25, feeBalance: 0.14, directExpenses: 0.03, defaultReturn: 9.0, description: "עוקב מדד S&P 500" },
      { id: "tradable_index", name: "מסלול סחיר (מדדים)", feeDeposit: 1.20, feeBalance: 0.15, directExpenses: 0.04, defaultReturn: 7.5, description: "מדדים סחירים" },
    ],
  },
];
