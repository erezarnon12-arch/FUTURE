...
const PRODUCTS = [
  {
    ...
    hasFeeDeposit: true,
    hasFeeBalance: true,
    note: "דמי הניהול המקסימליים לפי חוק: 6% מהפקדה, 0.5% מצבירה",
  },
  {
    id: "keren_hishtalmut",
    label: "קרן השתלמות",
    icon: "🎓",
    defaultFeeDeposit: 0,
    defaultFeeBalance: 0.8,
    maxFeeDeposit: 0,
    maxFeeBalance: 1.5,
    hasFeeDeposit: false,
    hasFeeBalance: true,
    note: "דמי ניהול מקסימליים: 1.5% מצבירה. אין דמי ניהול מהפקדה",
  },
  {
    ...
    icon: "💼",
    defaultFeeDeposit: 4,
    defaultFeeBalance: 1.2,
    maxFeeDeposit: 6,
    maxFeeBalance: 2,
    hasFeeDeposit: true,
    hasFeeBalance: true,
    note: "שים לב: ביטוח מנהלים נחשב יקר — כדאי לבדוק חלופות",
  },
  {
    id: "kupat_gemel",
    label: "קופת גמל",
    ...
    hasFeeDeposit: false,
    hasFeeBalance: true,
    note: "גמישה, ניתנת למשיכה בגיל 60. ללא דמי ניהול מהפקדה",
  },
  {
    id: "polisa",
    label: "פוליסת חיסכון",
    ...
    hasFeeDeposit: false,
    hasFeeBalance: true,
    note: "נזילה בכל עת, אך דמי ניהול גבוהים יחסית",
  },
];
